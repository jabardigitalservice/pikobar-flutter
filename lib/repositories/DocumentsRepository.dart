...
class DocumentsRepository {
  final documentsCollection = Firestore.instance.collection(Collections.documents);

  Stream<List<DocumentSnapshot>> getDocuments({int limit}) {
    Query documentsQuery = documentsCollection.orderBy('published_at', descending: true);
