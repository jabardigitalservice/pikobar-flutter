...
class InfoGraphicsRepository {
  final infoGraphicsCollection = Firestore.instance.collection(Collections.infographics);

  Stream<List<DocumentSnapshot>> getInfoGraphics({int limit}) {
    Query infoGraphicsQuery = infoGraphicsCollection.orderBy('published_date', descending: true);
