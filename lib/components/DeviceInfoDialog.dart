...
import 'package:pikobar_flutter/utilities/DeviceInfo.dart';
...
class DeviceInfoDialog extends StatelessWidget {
  ...
  Widget _iOSContent() {
    return FutureBuilder(
        future: DeviceInfo.iosDeviceInfo(),
            ...
            child: Column(
              children: <Widget>[
                ...
                _buildTile('Build mode:',
                    '${StringUtils.enumName(DeviceInfo.currentBuildMode().toString())}'),
  ...
  Widget _androidContent() {
    return FutureBuilder(
        future: DeviceInfo.androidDeviceInfo(),
